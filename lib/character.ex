defmodule Bonfire.Data.Social.Character do

  use Pointers.Mixin,
    otp_app: :bonfire_data_social,
    source: "bonfire_data_social_character"

  alias Pointers.Changesets
  require Pointers.Changesets
  alias Bonfire.Data.Social.Character
...
defmodule Bonfire.Data.Social.Character.Migration do
  ...
  defp make_character_table(exprs) do
    quote do
      ...
      Pointers.Migration.create_mixin_table(Bonfire.Data.Social.Character) do
  ...
  defp mc(:down) do
    quote do
      Bonfire.Data.Social.Character.Migration.drop_character_username_hash_index()
      Bonfire.Data.Social.Character.Migration.drop_character_username_index()
      Bonfire.Data.Social.Character.Migration.drop_character_table()
    end
  end
